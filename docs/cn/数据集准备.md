...
如果您需要出于学术目的使用 TSL-300 数据集，请下载[申请表](./assests/TSL-300_Data_Access_Form.docx)并填写申请信息，然后发送至 ***gloryzzc6@sina.com***。  
我们将尽快处理您的申请。  
请确保您使用的邮箱为教育机构邮箱。

### Data 准备
1. 准备 [TSL-300](./assests/TSL-300_Data_Access_Form.docx) 数据集  
    - 我们已提供构建好的数据集及预提取的特征。
